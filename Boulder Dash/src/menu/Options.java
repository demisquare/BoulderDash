		...
		try {
			background = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "background.png"));
			
			arrow_back = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "arrow_back.png")).getScaledInstance(120, 80, Image.SCALE_SMOOTH);
			
			paradiso = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Paradiso.png")).getScaledInstance(297, 61, Image.SCALE_SMOOTH);
			
			purgatorio = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Purgatorio.png")).getScaledInstance(313, 61, Image.SCALE_SMOOTH);
			
			inferno = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Inferno.png")).getScaledInstance(235, 61, Image.SCALE_SMOOTH);
			
			windowed = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Windowed.png")).getScaledInstance(265, 41, Image.SCALE_SMOOTH);
			
			fullscreen = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "FullScreen.png")).getScaledInstance(305, 41, Image.SCALE_SMOOTH);
			
			arrow_back_SELECTED = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "arrow_back_SELECTED.png")).getScaledInstance(120, 80, Image.SCALE_SMOOTH);
			
			paradiso_SELECTED = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Paradiso_SELECTED.png")).getScaledInstance(297, 61, Image.SCALE_SMOOTH);
			
			purgatorio_SELECTED = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Purgatorio_SELECTED.png")).getScaledInstance(313, 61, Image.SCALE_SMOOTH);
			
			inferno_SELECTED = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Inferno_SELECTED.png")).getScaledInstance(235, 61, Image.SCALE_SMOOTH);
			
			windowed_SELECTED = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "Windowed_SELECTED.png")).getScaledInstance(265, 41, Image.SCALE_SMOOTH);
			
			fullscreen_SELECTED = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "FullScreen_SELECTED.png")).getScaledInstance(305, 41, Image.SCALE_SMOOTH);
			
			music_unchecked = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "unchecked.png")).getScaledInstance(50, 50, Image.SCALE_SMOOTH);
			
			music_checked = ImageIO.read(
					new File("." + File.separator + "resources" + File.separator + "assets" + File.separator + "Menu"
							+ File.separator + "OptionsPage" + File.separator + "checked.png")).getScaledInstance(50, 50, Image.SCALE_SMOOTH);
