		...
		try {
			...
			Menu = ImageIO
					.read(new File("." + File.separator + "resources" + File.separator + "assets" + File.separator
							+ "Menu" + File.separator + "YouLosePage" + File.separator + "Menu.png")).getScaledInstance(250, 60, Image.SCALE_SMOOTH);

			Menu_SELECTED = ImageIO
					.read(new File("." + File.separator + "resources" + File.separator + "assets" + File.separator
							+ "Menu" + File.separator + "YouLosePage" + File.separator + "Menu_SELECTED.png")).getScaledInstance(250, 60, Image.SCALE_SMOOTH);

			Retry = ImageIO
					.read(new File("." + File.separator + "resources" + File.separator + "assets" + File.separator
							+ "Menu" + File.separator + "YouLosePage" + File.separator + "Retry.png")).getScaledInstance(250, 60, Image.SCALE_SMOOTH);

			Retry_SELECTED = ImageIO
					.read(new File("." + File.separator + "resources" + File.separator + "assets" + File.separator
							+ "Menu" + File.separator + "YouLosePage" + File.separator + "Retry_SELECTED.png")).getScaledInstance(250, 60, Image.SCALE_SMOOTH);
